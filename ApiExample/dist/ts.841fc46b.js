...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"ts/index.ts":[function(require,module,exports) {
"use strict";
...
var inputFact = document.getElementById("inputFact");
var form = document.getElementById("form");
var errorInput = document.getElementById("errorInput");
var infoFact = document.getElementById("response");
facts.selectedIndex = 0;
var fact = "year";
facts.addEventListener("change", function () {
...
form.addEventListener("submit", function (event) {
  ...
  var inputNumber = inputFact.value;
...
function makeRequest(fact, number) {
  var options = {
    method: "GET",
